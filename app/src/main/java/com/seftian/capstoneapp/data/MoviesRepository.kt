...
import com.seftian.capstoneapp.data.remote.response.MovieItemResponse
...
import com.seftian.capstoneapp.domain.repository.IMoviesRepository
            ...
            if (localDetail?.overview != null && localDetail.genres != null) {
                ...
                when (val response = movieRemoteDataSource.getDetailMovieFromNetwork(id).last()) {
                    is ResponseStatus.Success -> {
                        ...
                        // Save the detail locally if needed, you'll have to create this function in the local data source.
